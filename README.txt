...
Patches to Version patched-7.x-2.0-alpha2
-----------------------------------------
Patches made to version 7.x-2.0-alpha2 are included in the file PATCHED-7.x-2.0-alpha2.txt 

Note: the changes in civicrm.api.inc are specific to a client and will require
you to indicate the correct parent group ID or remove this for your use.
